...
Install_pecl_swoole() {
  if [ -e "${php_install_dir}/bin/phpize" ]; then
    ...
    if [[ "${PHP_main_ver}" =~ ^5.[3-6]$ ]]; then
      src_url=${mirror_link}/src/swoole-1.10.5.tgz
      src_url_backup=https://pecl.php.net/get/swoole-1.10.5.tgz
      ...
      src_url=${mirror_link}/src/swoole-4.5.2.tgz
      src_url_backup=https://pecl.php.net/get/swoole-4.5.2.tgz
      Download_src; unset src_url_backup
      ...
      src_url=${mirror_link}/src/swoole-${swoole_oldver}.tgz
      src_url_backup=https://pecl.php.net/get/swoole-${swoole_oldver}.tgz
      Download_src; unset src_url_backup
      ...
      src_url=${mirror_link}/src/swoole-${swoole_ver}.tgz
      src_url_backup=https://pecl.php.net/get/swoole-${swoole_ver}.tgz
      Download_src; unset src_url_backup
